...
echo    msvc12   Microsoft Visual C++ 2013
...
:oc_msvc12
echo Setting compiler: Microsoft Visual C++ 2013
echo COMPILER_NAME=vc12 >> build\Makefiles\nmake\config.mak
set SELECTED_COMPILER_VERSION=120
goto oc_msvc
